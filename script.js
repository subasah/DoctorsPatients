...
if (heroTitle) {
    ...
    heroTitle.textContent = originalText; // Keep static for now
}
...
window.addEventListener('scroll', () => {
    ...
    if (scrollDepth > maxScrollDepth) {
        ...
        // console.log('Max scroll depth:', Math.round(maxScrollDepth) + '%');
    }
});
...
console.log('🏥 Heidi Health - Landing Page Loaded');
console.log('Built with ❤️ for healthcare professionals');
